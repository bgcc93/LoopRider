...
public class SmoothFollowCSharp : MonoBehaviour
{
	...
	void  LateUpdate ()
	{
		...
		float wantedRotationAngle = rotTarget.eulerAngles.z;
		...
		//set rotation for christ's sake
		Quaternion finalRotation = Quaternion.Euler(0, 0, currentRotationAngle);
		transform.rotation = Quaternion.Slerp(transform.rotation, finalRotation, 0f);
